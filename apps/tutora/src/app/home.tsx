/**
 * `/home` — the authenticated landing route (issue #23).
 *
 * Guards on auth state (redirecting into onboarding when needed), then renders
 * the design-system showcase (epic #8) as the placeholder home: every component
 * in the Tutora UI kit, reviewable at a glance in light and dark mode. The
 * showcase will be replaced by the real home surface in a later epic.
 */
...
/**
 * Route entry: keep unauthenticated / not-yet-onboarded users out of the app.
 * Redirects are driven by auth state, so completing onboarding lands here.
 */
